...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class StorageAccountManagementPolicyData : ResourceData
    {
        ...
        internal StorageAccountManagementPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ManagementPolicyProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
