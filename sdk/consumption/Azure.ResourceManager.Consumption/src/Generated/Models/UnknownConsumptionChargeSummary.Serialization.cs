...
namespace Azure.ResourceManager.Consumption.Models
{
    internal partial class UnknownConsumptionChargeSummary : ConsumptionChargeSummary, IJsonModel<ConsumptionChargeSummary>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConsumptionChargeSummary IPersistableModel<ConsumptionChargeSummary>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownConsumptionChargeSummary)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConsumptionChargeSummary IJsonModel<ConsumptionChargeSummary>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownConsumptionChargeSummary)JsonModelCreateCore(ref reader, options);
