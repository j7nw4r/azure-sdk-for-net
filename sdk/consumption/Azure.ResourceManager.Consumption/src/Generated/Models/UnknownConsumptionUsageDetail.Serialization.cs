...
namespace Azure.ResourceManager.Consumption.Models
{
    internal partial class UnknownConsumptionUsageDetail : ConsumptionUsageDetail, IJsonModel<ConsumptionUsageDetail>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConsumptionUsageDetail IPersistableModel<ConsumptionUsageDetail>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownConsumptionUsageDetail)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConsumptionUsageDetail IJsonModel<ConsumptionUsageDetail>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownConsumptionUsageDetail)JsonModelCreateCore(ref reader, options);
