...
namespace Azure.ResourceManager.Consumption.Models
{
    internal partial class UnknownConsumptionReservationRecommendation : ConsumptionReservationRecommendation, IJsonModel<ConsumptionReservationRecommendation>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConsumptionReservationRecommendation IPersistableModel<ConsumptionReservationRecommendation>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownConsumptionReservationRecommendation)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConsumptionReservationRecommendation IJsonModel<ConsumptionReservationRecommendation>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownConsumptionReservationRecommendation)JsonModelCreateCore(ref reader, options);
